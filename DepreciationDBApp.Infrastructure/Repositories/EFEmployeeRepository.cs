...
namespace DepreciationDBApp.Infrastructure.Repositories
{
    public class EFEmployeeRepository : IEmployeeRepository
    {
        ...
        public bool SetAssetsToEmployee(Employee employee, List<Asset> assets, DateTime efectiveDate)
        {
            ...
            Employee dat = FindByDni(employee.Dni);
            ...
            {
                Asset data = depreciationDbContext.Assets.FirstOrDefault(p => p.Id.Equals(item.Id));
                ...
                {
                    depreciationDbContext.AssetEmployees.Add(new AssetEmployee()
                    {
                        Employee = employee,
                        Asset = item,
                    });
            ...
            return depreciationDbContext.SaveChanges() > 0;
        }
        ...
        public bool SetAssetToEmployee(Employee employee, Asset asset, DateTime efectiveDate)
        {
            ...
            Asset data = depreciationDbContext.Assets.FirstOrDefault(p => p.Id.Equals(asset.Id));
